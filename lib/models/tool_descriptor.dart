...
/// Ordered gesture tools shown in the Draw family of the rail. Smudge sits
/// with the freehand brushes; blur is not a rail tool (it lives under Adjust,
/// applied to a region or painted).
...
class ToolDescriptor {
  /// Creates a gesture-tool entry (Draw family) for [action].
  ...
  /// The gesture action for a Draw entry; null for an adjustment.
  ...
  ToolFamily get family => effect != null ? ToolFamily.adjust : ToolFamily.draw;
