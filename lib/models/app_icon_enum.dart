...
enum AppIcon {
  ...
  effectBrightness('assets/icons/effect_brightness.svg'),
  effectContrast('assets/icons/effect_contrast.svg'),
  effectGrayscale('assets/icons/effect_grayscale.svg'),
  effectHueRotation('assets/icons/effect_hue_saturation.svg'),
  effectSaturation('assets/icons/effect_saturation.svg'),
  effectNoise('assets/icons/effect_noise.svg'),
  effectPixelate('assets/icons/effect_pixelate.svg'),
  effectShadow('assets/icons/effect_shadow.svg'),
  ...
  fileSheet('assets/icons/file_sheet.svg'),
  ...
  selectorLasso('assets/icons/selector_lasso.svg'),
  selectorWand('assets/icons/selector_wand.svg'),
  settings('assets/icons/settings.svg'),

  selectorMathAdd('assets/icons/selector_math_add.svg'),
  selectorMathInvert('assets/icons/selector_math_invert.svg'),
