...
class _TextEditorState extends State<TextEditor> {
  ...
  void _showEditTextDialog() {
    ...
    // [showAppBottomSheet] re-provides the editor's controller scopes around
    // the sheet subtree, so the dialog (and any color picker opened from
    // within it) resolves [LayersProvider.of] itself.
